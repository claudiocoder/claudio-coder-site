...
3. 3 - Usemos git rebase cuando queremos pasar cambios de una rama pública a una rama privada (feature). Esto nos ayudara a mantener un historial limpio y ordenado.
